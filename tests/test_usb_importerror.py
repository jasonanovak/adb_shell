...
class TestUsbImportError(unittest.TestCase):
    def test_import_error(self):
        ...
        from adb_shell_wifi import adb_device
        from adb_shell_wifi.exceptions import InvalidTransportError
        ...
        with patch("adb_shell_wifi.adb_device.UsbTransport", None):
    ...
    def test_import_successful(self):
        ...
        if UsbTransport is not None:
            ...
            with patch("adb_shell_wifi.adb_device.UsbTransport", UsbTransport):
                with patch("adb_shell_wifi.adb_device.UsbTransport.find_adb", return_value=UsbTransport("TODO", "TODO")):
                    adb_device.AdbDeviceUsb("serial")
